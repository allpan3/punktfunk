...
public enum Licenses {
    ...
    /// The Swift packages linked beside the Rust crates.
    public static let swiftPackages =
        "Punktfunk uses Glur (progressive backdrop blur), © 2023 João Gabriel, under the MIT License."

    /// What leads the notices on every screen that shows them.
    public static let thirdPartyIntro =
